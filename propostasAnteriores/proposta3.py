'''
Prop 3, aloca 50% caminho primario e backup, usando lista de caminhos
'''
        ...
        for count in xrange(1, NUM_OF_REQUESTS+1):
            ...
            if slots[0] == True:
                ...
                if pathBkp[0] == True:
                    ...
                    SimPy.Simulation.activate(d2, d2.run(req.idReq, req.pathBkp, req.slotsAlocadosBkp, req.time+duracao, req.duracao, self.topology))
